import { Avatar, Box, Button, Flex, Image, SimpleGrid, Skeleton, Text, Wrap, WrapItem } from '@chakra-ui/react'
...
function LaptopSingle() {
    ...
    useEffect(()=>{
      setIsLoaded(true)
        axios.get(`https://olx-data-server-hwrf.onrender.com/laptops/${_id}`).then((res)=>{
          setData(res.data)
          setIsLoaded(false)
        })
    },[])
         ...
         <Skeleton startColor='black' endColor='white' isLoaded={isLoaded}>
            ...
            <Box width={"100%"} margin="auto" height={"auto"}  boxShadow='0 0 15px 2px #efdfde' p={6}> 
                 ...
                 <Box >
                   ...
                   <Wrap>
                    <WrapItem>
                        <Avatar size='2xl' name='Dan Abrahmov' src='https://st2.depositphotos.com/1104517/11965/v/950/depositphotos_119659092-stock-illustration-male-avatar-profile-picture-vector.jpg' />
                    </WrapItem>
                 </Wrap>
                    <Box marginTop={"30px"}>
                    <Text>
