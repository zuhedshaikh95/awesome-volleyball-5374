    ...
    <>
      {
        ...
        <Box display={"flex"}>
        <Text fontSize={["22px","24px","26px","32px"]} textDecoration="underline">
         FAVORITES
         </Text>
        </Box>
         ...
         <Box p={4} bg={"#6495ED"} borderRadius="10px" height={"400px"} marginTop="20px" color="white">
             <Box margin={"auto"}>
         ...
         </Skeleton>
         {
          favItem.map((item)=>(
            ...
            <Box  key={item._id} margin={"auto"} maxW='sm' borderWidth='1px' borderRadius='lg' overflow='hidden'>
               
            <Box onClick={()=>deleteFromFav(item._id)} display={"flex"} justifyContent={"flex-end"} >
                {/* <Tooltip label="I don't close on click" closeOnClick={false}> */}
                <FaHeart  size={25} style={{marginRight:"10px",marginTop:"20px"} }/>
                {/* </Tooltip> */}
